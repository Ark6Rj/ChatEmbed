        ...
        <div
          style={{
            ...
            'background-image': props.theme?.chatWindow?.backgroundImage
              ...
              : 'url(https://cdn.jsdelivr.net/gh/Ark6Rj/ChatEmbed@v0.0.1/src/assets/bgc1.svg), url(https://cdn.jsdelivr.net/gh/Ark6Rj/ChatEmbed@v0.0.1/src/assets/bgc2.png), linear-gradient(173deg, #f4f9ff -24.94%, #edf1f9 103.15%)',
            'background-size': '100%',
